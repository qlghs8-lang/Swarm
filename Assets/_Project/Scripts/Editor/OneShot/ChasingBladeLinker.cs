...
{
    public static class ChasingBladeLinker
    {
        private const string SwordAsepritePath = "Assets/_Project/Textures/Effects/sword3.aseprite";
        ...
        [MenuItem("Swarm/Art Test/Link Warrior Chasing Blade Sprite (Both Scenes)")]
        private static void Link()
        {
            ...
            Debug.Log($"Linked chasing blade sprite to WarriorSwordChasingWeapon in both scenes. " +
        ...
        private static void LinkInScene(string scenePath, Sprite sprite)
        {
            ...
            var weapon = player.GetComponent<WarriorSwordChasingWeapon>();
            if (weapon == null)
            {
                Debug.LogError($"WarriorSwordChasingWeapon component not found on Player in {scenePath}. Skipped.");
                return;
            }
