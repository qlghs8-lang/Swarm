...
| 드랍 픽업 (경험치·골드·자석) | 🟡 진행 중 | aseprite-mcp 생성. 경험치 3단계 + 골드 2종 배선 완료, 자석은 아직 배선 전 |
| 보스 | 미정 | 현재 탱커 스프라이트 재사용 중 |
...
| 드랍 픽업 — 경험치 3단계/골드 2종/자석 | 🟡 진행 중 — aseprite-mcp. 경험치·골드는 프리팹 배선 완료(획득량에 따라 스프라이트 자동 전환), 자석은 아직 배선 전 |
| 보스 | 미정 — 현재 탱커 스프라이트 재사용 |
